...
class NeuralNetwork():
    ...
    def train(self, x1, x2, y):
        ...
        #out = np.vectorize(output_layer_activation)
        ...
        hidden_layer_error = np.multiply(np.transpose(self.hidden_to_output_weights)*output_layer_error,d_relu(hidden_layer_weighted_input))
        ...
        self.hidden_to_output_weights = self.hidden_to_output_weights + np.transpose(self.learning_rate*hidden_to_output_weight_gradients)
